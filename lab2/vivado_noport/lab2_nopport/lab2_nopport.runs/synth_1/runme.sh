...
HD_PWD='/nfs/home/d/de_math/COEN313/lab2/vivado_noport/lab2_nopport/lab2_nopport.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sums.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sums.tcl
