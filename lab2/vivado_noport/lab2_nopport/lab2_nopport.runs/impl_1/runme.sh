...
HD_PWD='/nfs/home/d/de_math/COEN313/lab2/vivado_noport/lab2_nopport/lab2_nopport.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sums.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sums.tcl -notrace
